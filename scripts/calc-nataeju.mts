/** 나태주(1990-12-21) 숏츠 28호 명리 산출 + 일주 60갑자 독립 검산.
 *  실행: TZ=UTC NODE_OPTIONS='--conditions=import' node_modules/.bin/tsx scripts/calc-nataeju.mts */
...
const people = [{ name: "나태주", birthDate: "1990-12-21", gender: "m" }];
...
L(`[검산] 1990-12-21 = ${dayPillar(1990, 12, 21)} ← 나태주 일주 (매거진 기대: 경신)`);
