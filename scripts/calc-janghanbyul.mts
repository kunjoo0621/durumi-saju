/** 장한별(김장한별, 1990-07-04) 숏츠 24호 명리 산출.
 *  실행: TZ=UTC NODE_OPTIONS='--conditions=import' node_modules/.bin/tsx scripts/calc-janghanbyul.mts */
...
const people = [{ name: "장한별", birthDate: "1990-07-04", gender: "m" }];
