...
export const taegang: DictEntry = {
  ...
  faq: [
    {
      q: "태강과 극왕은 어떻게 다른가요?",
      a: "정도의 차이입니다. 태강은 사주 대부분이 비겁·인성이지만 다른 오행도 일부 자리 잡고 있는 상태, 극왕은 사주가 한 오행만으로 채워져 다른 오행이 거의 없는 상태입니다. 극왕은 종격으로 풀이될 가능성이 있고, 태강은 일반 신강 논리로 풀이됩니다.",
    },
    {
