...
export const TAG_META: Record<string, TagMeta> = {
  ...
  "2027운세": { label: "2027 운세", group: "주제", desc: "정미년 2027, 그 해 두 글자가 내 사주와 만나는 자리." },
...
export const TAG_ORDER: string[] = [
  "연예인", "트로트", "아이돌", "배우",
  "재물운", "연애운", "궁합", "결혼운", "직업운", "신살", "십성", "사주기초", "삼재", "공망", "2026운세", "2027운세",
  "꿈해몽", "동물꿈", "태몽",
...
export const STORY_TAGS: Record<string, string[]> = {
  ...
  "jangseong-sal": ["신살", "사주기초"],
  "yukhae-sal": ["신살", "사주기초"],
  yuyoungwoo: ["연예인", "기토"],
  yangsejong: ["연예인", "배우", "계수"],
  "v-bts": ["연예인", "아이돌", "을목"],
  "wonjin-sal": ["신살", "궁합"],
