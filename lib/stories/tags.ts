...
export const TAG_META: Record<string, TagMeta> = {
  ...
  신살: { label: "신살", group: "주제", desc: "도화살·홍염살·원진살·역마살 등 타고난 기운의 결을 보는 신살." },
...
export const STORY_TAGS: Record<string, string[]> = {
  ...
  sojiseop: ["연예인", "배우", "을목"],
  joseungwoo: ["연예인", "배우", "경금"],
  "jimin-bts": ["연예인", "아이돌", "정화"],
  noyunseo: ["연예인", "배우", "임수"],
  "wonhee-illit": ["연예인", "아이돌", "신금"],
  "parkeunbin": ["연예인", "배우", "계수"],
  "gonghyojin": ["연예인", "배우", "정화"],
  "leedongwook": ["연예인", "배우", "무토"],
  "turtle-dream": ["꿈해몽", "동물꿈", "재물운"],
  "bird-dream": ["꿈해몽", "동물꿈"],
  "earthquake-dream": ["꿈해몽"],
  "money-loss-dream": ["꿈해몽", "재물운"],
  "ring-dream": ["꿈해몽", "결혼운", "연애운"],
  "yeonae-vs-gyeolhon": ["연애운", "결혼운", "십성"],
  "hakdang-gwiin": ["신살", "사주기초", "직업운"],
  "cheonui-seong": ["신살", "직업운"],
  "bigyeop-saju": ["십성", "사주기초", "재물운"],
  "singang-sinyak": ["사주기초", "십성"],
  "rain-dream": ["꿈해몽"],
  namjoohyuk: ["연예인", "배우", "기토"],
  yoonkyungho: ["연예인", "배우", "기토"],
  taeyeon: ["연예인", "아이돌", "무토"],
  seoinguk: ["연예인", "배우", "을목"],
  anton: ["연예인", "아이돌", "기토"],
  ...
  "pyeongwan-chilsal": ["십성", "결혼운"],
  "unseong-jewang-myo-jeol": ["사주기초"],
  "jaeseong-wife": ["결혼운", "궁합"],
