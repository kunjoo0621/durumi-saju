...
- 30~60자 (기존보다 길어도 됨)
- 읽자마자 "누가 이겼고, 왜 재밌는지"가 바로 이해되는 문장
- 톤: 친구한테 결과 자랑하는 느낌. 반전 or 여유가 있어야 해.

[heroQuip 문법 규칙 — 가장 중요]
- 승자 이름에 반드시 주격 조사("이/가")를 붙여라
- 패자 이름에 반드시 목적격 조사("을/를/한테/의")를 붙여라
- 쉼표(,)로 두 이름을 나열하지 마라. 주어-목적어 관계가 불명확해진다
- 승패 결과 + 구체적 장면이나 이유가 한 문장에 담겨야 함
- 단순 결과 보고("A가 이겼다") 금지. 왜/어떻게 이겼는지가 보여야 재밌음

재미 패턴 (반드시 하나 이상 사용):
  ✅ 역습 반전: "김채연이 재물운으로 신건주 지갑 완전 털어갔는데, 건강운에서 역습당했지"
  ✅ 체면 세우기: "신건주한테 직장운은 처참하게 졌는데, 김채연이 건강 하나로 체면 세웠어"
  ✅ 한 방 구조: "김채연이 3:2로 이기긴 했는데, 신건주 대인운이 마지막에 한 방 먹였지"
  ✅ 자존심: "돈도 연애도 김채연한테 다 뺏겼는데, 신건주가 건강 하나로 자존심 지켰어"
  ✅ 찐 인정 (무승부): "사주도 이 둘은 못 가려, 찐 라이벌이야"

금지 패턴:
  ❌ 쉼표 나열: "김채연, 신건주 지갑 텅 비게 만들었지" (누가 누군지 불명확)
  ❌ 조사 누락: "김채연 신건주 완전 발랐지" (주어-목적어 불명확)
...
승패 강도별 톤 가이드:
- 신승(3:2): 역전/한끗 차이 강조. "돈복 하나로 뒤집었어", "마지막에 한 방 먹였지"
- 압승(4:1): 승자의 여유. "4판 먹고 1판은 인심으로 줬어", "이 정도면 접수야"
- 완전압살(5:0): 과장+유머. "대결이 아니라 수업이었어", "혼자 다 해먹었어"
...
8. heroQuip은 승자 이름+주격 조사("이/가")로 시작, 패자 이름에 목적격 조사("을/를/한테") 필수, 쉼표로 이름 나열 금지 (무승부 제외)
...
{
  "heroQuip": "30~60자, 승자 이름+주격 조사로 시작, 패자 이름+목적격 조사, 이긴 카테고리 1개 이상 포함, 쉼표로 이름 나열 금지",
  "categoryResults": {
