...
export const STRENGTH_DESCRIPTIONS: Record<string, string> = {
  "극왕": "일간의 힘이 매우 강해 종격에 가까운 특수 사주",
  "태강": "일간의 세력이 압도적으로 강함. 자기 주장이 매우 강함",
  "신강": "일간의 힘이 강함. 리더십과 추진력이 있음",
  "중화신강": "일간이 약간 강한 편. 균형에 가까우나 자기 주도적",
  "중화신약": "일간이 약간 약한 편. 균형에 가까우나 유연한 성향",
  "신약": "일간의 힘이 약함. 협력과 지원이 중요함",
  "태약": "일간의 세력이 매우 약함. 주변 환경에 크게 영향받음",
  "극약": "일간의 힘이 극도로 약해 종격에 가까운 특수 사주",
};
