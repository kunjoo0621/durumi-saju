...
- ✅ 종합 판정: 3문장 이내 한줄 판결. 각 섹션 내용 반복 금지.
...
[섹션 8] 종합 판정 — 구조: "3문장 판결"
  → 3문장 이내로 끝내라. 절대 초과 금지.
  → 각 카테고리 점수를 다시 나열하지 마라 (이미 레이더 차트에 있음).
  → "결국 네 사주는 ~이다. ~가 제일 문제고, ~하지 않으면 ~된다." 구조.
  → ★ 팩폭 의무 1회(강도 mid).
  → 마지막 문장은 반드시: "바꿀 수 있는 건 사주가 아니라 네 다음 행동이야." (이 문장 고정, 변형 금지)
