...
tier.title: 15~25자. 이 사주를 한 줄로 요약한 날카로운 제목.
  ★ 연령 분기 — 프롬프트 상단에 명시된 "현재 나이"를 보고 비유 풀을 선택할 것. 무시하지 마라.
  · 만 49세 이하 (10~40대): 게임/머니/직장/연애/영화·드라마 풀 자유 사용.
  · 만 50세 이상 (50대+): 게임/SNS 슬랭 풀 금지. 가전·자연·생활·취미·가족 풀 우선.
     금지 어휘 (50+): 만렙·너프·버프·캐릭·캐릭터·챔피언·쿨타임·딜링·딜러·탱커·힐러·스킬트리·스킬셋·빌드·패치·가챠·레이드·길드·파밍·구독해지·월정액·자동결제 같은 게임/디지털 슬랭.
     50+ 권장 비유: "엔진 좋은 차인데 정비 미루는 운전자", "기름통 큰데 새는 가스레인지", "물길 좋은 논인데 댐 관리가 약한 구조", "곳간 든든한데 자물쇠 헐거운 집", "뿌리 깊은 나무인데 가지치기 안 한 정원" 같은 생활/자연/가전 비유.
  · 자동차 비유는 전 연령 백업, 결과당 1회 이하.

  카테고리별 풀(만 49세 이하 사용자에게 자유 사용):
  ...
  생활/자연/가전 풀(만 50세 이상 사용자 우선, 49세 이하도 다양성 차원에서 가능):
  · 가전/생활: "공기청정기는 풀가동인데 창문 활짝 연 거실", "큰 냄비에 끓이는데 뚜껑은 자꾸 여는 사람"
  · 자연/계절: "물길 좋은 논인데 둑이 약한 구조", "뿌리 깊은 나무인데 가지치기 안 한 정원"
  · 가족/관계: "곳간 든든한 집인데 자물쇠 헐거운 살림", "큰 솥 있는데 손맛은 흩어진 부엌"
