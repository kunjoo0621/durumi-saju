...
import { X, Egg } from "@phosphor-icons/react";
            ...
            <div className="px-1 py-1">
              ...
              >
                ...
                <div className="flex-1 min-w-0 text-left">
                  <div className="text-[16px] font-semibold text-text-primary">내 사주 결과</div>
                  <div className="text-[13px] text-text-tertiary mt-0.5">이전에 본 결과 다시 보기</div>
                </div>
              ...
              >
                ...
                <div className="flex-1 min-w-0 text-left">
                  <div className="text-[16px] font-semibold text-text-primary">알 충전</div>
                  <div className="text-[13px] text-text-tertiary mt-0.5">사주 이용권 충전하기</div>
                </div>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" className="text-text-tertiary">
                  <path d="M9 6l6 6-6 6"/>
                </svg>
