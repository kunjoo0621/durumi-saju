  ...
  return (
    <div className="min-h-screen bg-[rgb(var(--c-dark-bg))] text-white">
      ...
      <main>
        ...
        >
          <div className="relative mx-auto max-w-[720px] px-5 sm:px-0 text-center">
      ...
      <BusinessFooter
        footerClassName="border-t border-white/[0.06] bg-[rgb(var(--c-dark-bg))] pb-[calc(120px+env(safe-area-inset-bottom))]"
        innerClassName="mx-auto max-w-[720px] px-5 sm:px-0 pt-10 text-[13px] leading-[180%] text-[rgb(var(--c-text-muted))]"
      />

      {/* ── 하단 스티키 CTA ── */}
      <div className="fixed inset-x-0 bottom-0 z-[130] bg-[linear-gradient(0deg,rgba(0,0,0,1)_0%,rgba(0,0,0,1)_calc(70px+env(safe-area-inset-bottom)),rgba(0,0,0,0)_100%)] px-5 pt-4 pb-[calc(16px+env(safe-area-inset-bottom))] max-w-[640px] mx-auto">
